...
test('group returns all settings in group', function (): void {
    $this->service->set('branding', 'app_name', 'My App');
...
test('group returns empty array for nonexistent group', function (): void {
